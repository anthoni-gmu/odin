...
import Navbar from '../../components/cart/Navcar'
                                        ...
                                        <Disclosure as="div" className="border-t border-gray-200 px-4 py-6">
                                            {({ open }) => (
                                                <>
                                                    <h3 className="-mx-2 -my-3 flow-root">
                                                        <Disclosure.Button className="px-2 py-3 bg-white w-full flex items-center justify-between text-gray-400 hover:text-gray-500">
                                                            <span className="font-sofiapro-regular text-gray-900">Colores</span>
                                                            <span className="ml-6 flex items-center">
                                                                {open ? (
                                                                    <MinusSmIcon className="h-5 w-5" aria-hidden="true" />
                                                                ) : (
                                                        ...
                                                        <Disclosure.Panel className="pt-6">
                                                            <div className="space-y-6">
                                                                ...
                                                                </div>
                                                                {
                                                                    ...
                                                                    colors.map(color => {
                                                                        return (
                                                                            <div key={color.id} className=' flex items-center h-5 my-5'>
                                                                                <input
                                                                                    name='color_id'
                                                                                    onChange={e => onChange(e)}
...
const mapStateToProps = state => ({
    ...
    searched_products: state.Product.search_products,
