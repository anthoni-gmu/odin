                      ...
                      <>
                        <h3 className="-mx-2 -my-3 flow-root">
                          <Disclosure.Button className="px-2 py-3 rounded-lg bg-orange-200 w-full flex items-center justify-between text-gray-400 hover:text-gray-500">
                            <span className="font-sofiapro-regular text-black font-semibold">Colores</span>
                          ...
                          <Disclosure.Panel className="pt-6">
                            <div className="lg:col-span-3">
                              ...
                              <div className=' flex items-center h-5 my-5'>
                                ...
                                />
                                <label className="ml-3 min-w-0 flex-1 text-white">
                                  Todos
                                </label>
                              </div>
                                      ...
                                      return (
                                        <div key={color.id} className=''>
                                          ...
                                          <input
                                            ...
                                            className='focus:ring-blue-500  h-4 w-4 text-blue-600 border-gray-300 rounded-full'
                                          />
                                          <label className="ml-3 min-w-0 flex-1 text-amber-300">
                                            {color.name}
                                          </label>
                                        </div>
                                      )
